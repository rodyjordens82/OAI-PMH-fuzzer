...
# OAI-PMH endpoint
#OAI_PMH_URL = "https://tnov6-oai.vakliteratuur.info/OaiPmh" #use for just fuzzing
#OAI_PMH_URL = "http://localhost:8080/server/oai/request" #use for just fuzzing
#OAI_PMH_URL = "http://islandora.io/oai/request" #use for just fuzzing
OAI_PMH_URL = "http://localhost:8081/oai/request" #use in combination with sanitizer
